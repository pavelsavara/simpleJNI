...
namespace simpleJNI.JNI
{
    public unsafe partial class JNIEnv
    {
        ...
        {
            public JNIEnvFunctions* functions;
        }

        [StructLayout(LayoutKind.Sequential), NativeCppClass]
        internal struct JNIEnvFunctions
        {
            IntPtr reserved0;
            IntPtr reserved1;
            IntPtr reserved2;
            ...
            public delegate* unmanaged<JNIEnvNative*, JniThrowable> ExceptionOccurred;
            public delegate* unmanaged<JNIEnvNative*, void> ExceptionDescribe;
            public delegate* unmanaged<JNIEnvNative*, void> ExceptionClear;
